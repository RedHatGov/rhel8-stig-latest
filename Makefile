...
all:
	...
	/usr/bin/xsltproc --stringparam profileId stig --stringparam map-to-items content/build/rhel8/xccdf-linked-srg-overlay.xml  --stringparam ocil-document content/build/rhel8/ocil-linked.xml --output table-rhel8-srgmap-flat.csv srg-to-csv.xslt content/shared/references/disa-os-srg-v1r6.xml
